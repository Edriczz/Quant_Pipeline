...
2. build_verdict branches:
   - Not stationary
   - Stationary + above mean (z > 0.5)
   - Stationary + below mean (z < -0.5)
   - Stationary + near mean (|z| <= 0.5)
"""
...
class TestBuildVerdict:
    def test_not_stationary_branch(
        ...
        verdict = build_verdict(ou_result, non_stationary_result, current_val=5.5)
    ...
    def test_stationary_above_mean_branch(
        ...
        verdict = build_verdict(ou_result, stationary_result, current_val=5.3)  # z = +1.5
    ...
    def test_stationary_below_mean_branch(
        ...
        verdict = build_verdict(ou_result, stationary_result, current_val=4.7)  # z = -1.5
    ...
    def test_stationary_near_mean_branch(
        ...
        verdict = build_verdict(ou_result, stationary_result, current_val=5.02)  # z = +0.1
